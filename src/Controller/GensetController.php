        ...
        if ($smartMod != null) { // Test si le module existe dans notre BDD
            ...
            if ($smartMod->getModType() == 'FUEL') {
                ...
                $datetimeData->setDateTime($date)
                    ...
                    ->setTotalEnergy($paramJSON['EL'])
                    ->setFuelInstConsumption($paramJSON['FuelInstComsumption'])
                    ->setNbPerformedStartUps($paramJSON['NPS'])
                    ->setNbMainsInterruption($paramJSON['NMI'])
                    ->setTotalRunningHours($paramJSON['TRH'])
                    ->setSmartMod($smartMod);
            }
